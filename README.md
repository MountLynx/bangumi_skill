...
| **bangumi-tracker** | ✅ 可用 | + OAuth 登录、收藏管理、观看进度 | 需要管理个人收藏 |
...
2. 填写应用信息：
   - 应用名称：任意（如 "bangumi-tracker"）
   - 应用简介：任意
   - 应用主页：任意 URL（如 https://github.com/MountLynx/bangumi_skill）
...
| bangumi-tracker | 1.0 | 2026-04-04 | 本地用户版，支持 OAuth + 收藏管理，Windows 凭据管理器安全存储 |
